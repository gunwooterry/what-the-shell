...
function showManual(command) {
  ...
  switch (command.split(' ')[0]) {
    case 'cd' : loremIpsum = 'cd means changing directory'; break;
    case 'cp' : loremIpsum = 'cp means copy'; break;
    case 'cat' : loremIpsum = 'cat shows the target file\'s content'; break;
    case 'rm' : loremIpsum = 'rm means remove'; break;
    default : break;
  }
